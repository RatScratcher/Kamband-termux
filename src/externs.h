...
extern const mutation_type mutation_info[MAX_MUTS];
extern bool has_mutation(int mut);
...
extern bool vision_pulse;
extern bool crushing_active;
extern int crushing_cy;
